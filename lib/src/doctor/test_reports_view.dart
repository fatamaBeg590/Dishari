...
class _TestReportsViewPageState extends State<TestReportsViewPage> {
            ...
            Container(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    Text("(Actual file would be displayed here)"),
                  ],
                ),
              ),
            ),
  ...
  void _deleteTestReport(String testId) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("Test report deleted successfully")),
    );
  }
  ...
  void _markAsReviewed(String testId) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("Test report marked as reviewed")),
    );
  }
      ...
      body: _uploadedTests.isEmpty
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              leading: Icon(Icons.upload_file, color: _getStatusColor(test['status'])),
