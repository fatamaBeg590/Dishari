...
class _PrescriptionPageState extends State<PrescriptionPage> {
  ...
  Widget _buildMedicineInputField(TextEditingController controller, String hint) {
              ...
              child: Row(
                ...
                children: [
                  ...
                  Image.asset(
                    ...
                    fit: BoxFit.contain,
                    errorBuilder: (context, error, stackTrace) => const Icon(Icons.local_hospital, size: 40),
                  ),
                  const SizedBox(width: 8),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: _buildMedicineInputField(
                                        medicine.nameController, "Name"),
                                  ),
                                  // Dosage - Flex: 2
                                  Expanded(
                                    flex: 2,
                                    child: _buildMedicineInputField(
                                        medicine.dosageController, "Dosage"),
                                  ),
                                  // Duration - Flex: 1
                                  Expanded(
                                    flex: 2,
                                    child: _buildMedicineInputField(
                                        medicine.durationController, "Duration"),
                                  ),
                                ],
                              );
                            },
