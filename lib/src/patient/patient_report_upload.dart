...
class _PatientReportUploadState extends State<PatientReportUpload> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Upload External Report", style: TextStyle(color: Colors.blueAccent)),
        centerTitle: true,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                readOnly: true,
                onTap: _pickDate,
                decoration: _inputDecoration("Date of Test", Icons.calendar_month).copyWith(
                  suffixIcon: Icon(Icons.edit, color: kPrimaryColor.withOpacity(0.7)),
                ),
                validator: (value) => value!.isEmpty ? 'Please select the test date' : null,
              ),
              const SizedBox(height: 30),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _selectedFile == null ? kPrimaryColor.withOpacity(0.05) : kPrimaryColor.withOpacity(0.15),
                    borderRadius: BorderRadius.circular(15),
                    border: Border.all(
                      color: _selectedFile == null ? Colors.blueGrey.shade200 : kPrimaryColor,
                      width: 2,
                    ),
                  ),
                  child: Column(
                    children: [
                      Icon(
                        _selectedFile == null ? Icons.file_upload : Icons.check_circle,
                        size: 50,
                        color: _selectedFile == null ? Colors.blueGrey : kPrimaryColor,
                      ),
                      const SizedBox(height: 10),
                      Text(
                        _selectedFile == null ? "Tap to Select File (PDF/Image)" : "File Selected:",
                        style: TextStyle(
                          fontSize: 16,
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    if (_formKey.currentState!.validate() && _selectedFile != null) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Please select file and complete all fields")),
                      );
                    }
                  },
