...
class _PatientPrescriptionsPageState extends State<PatientPrescriptions> {
  ...
  final List<Map<String, dynamic>> prescriptions = [
    {
      ...
      "examination": "BP: 120/80, Temp: 100°F, Pulse: 80/min",
      "medicines": [
        {
          "name": "1. Paracetamol",
          "dosage": "1+1+1",
    ...
    },
    {
      ...
      "examination": "Temp: 98.6°F, Throat: Inflamed, Chest: Clear",
      "medicines": [
        {
  ...
  Future<void> _loadFont() async {
    try {
      ...
      if (!_isDisposed) print('Bengali font loaded successfully.');
    } catch (e) {
      ...
      pdf.addPage(
        pw.Page(
          ...
          build: (pw.Context context) {
            final baseTextStyle = pw.TextStyle(fontSize: 10, font: defaultFont);
                      ...
                      pw.Column(
                        ...
                        children: [
                          if (hasBengaliFont) ...[
                            ...
                            pw.Text(
                              "‡bvhvLvjx weÁvb I c«hyw³ wek¦we`¨vjh",
                              style: pw.TextStyle(
                                fontSize: 14,
                                font: _bengaliFont!,
                              ),
